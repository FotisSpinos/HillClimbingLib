import {
  BaseHillClimbingState,
  FirstChoiceHillClimbing,
  HillClimbing,
} from "../src/sisyphos";

describe("HillClimbing", () => {
  class Path implements BaseHillClimbingState {
    ...
    public expand(): BaseHillClimbingState[] {
  ...
  test("Complete Search", () => {
    let path = Path.first();
    let search = new HillClimbing(path, (x) => (x as Path).getHeight());
...
describe("FirstChoiceHillClimbing", () => {
  class CrossRoad implements BaseHillClimbingState {
